...
| RINE | 0.9098 | |
| **ours, CLIP ViT-B/16 @448** | **0.7948 to 0.8092** | 13.5K to 14.8K images, encoder frozen |
| IML-ViT | 0.7573 | |
...
Mean held-out recall is 0.723 for CLIP against 0.651 for DINOv2. The ai_generated
